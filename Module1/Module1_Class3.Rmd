...
Holding poverty status and age constant, the log odds of disease of ever smokers is `r round(1 - coef(model2)["eversmkEver smoker"], digits = 3)` less than that of never smokers. Again holding poverty status and age constant, the odds of disease is `r round(exp(coef(model2)["eversmkEver smoker"]), digits = 3)` times greater among ever smokers when compared to never smokers.
...
The odds of disease are 1.89 times higher for those who have smoked than those who haven't smoked before (holding education and poverty status constant) and 4.83 times higher for those who are poor than those who aren't (holding smoking status and education constant). For education, the odds of disease for someone with some college education are 0.88 times that of someone who has completed college (holding smoking and poverty status constant). The odds of disease for someone who has graduated high school are 1.07 times higher than someone who's completed college and for someone who has some other education the odds are 1.17 times higher than someone who's completed college (holding smoking and poverty status constant).
...
The odds of disease (mscd) for ever smokers is 1.88 times (88% higher than) the odds of disease for non-smokers, holding agegroup and sex constant. Moreover, the odds of disease for females is 0.74 times (26% lower than) the odds of disease for males, holding smoking status and agegroup constant. Lastly, older age is asssociated with higher odds of disease, holding smoking status and sex constant. 
...
$$\log(OR) = \frac{odds \ for \ ES}{odds for NS} = \frac{p_{ES}\Big/ (1-p_{ES})}{p_{NS}\Big/ (1-p_{NS})}$$
